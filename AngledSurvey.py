...
z4 = -8
z5 = -15
print("make sure we are hovering at 3 , 7 , 10 , 16 and 21 meters respectively...")
...
while(y <= 42):
    ...
    d2 = client.moveToPositionAsync(x,y,z2,s,vehicle_name="Drone2")
    d3 = client.moveToPositionAsync(x,y,z3,s,vehicle_name="Drone3")
    d4 = client.moveToPositionAsync(x,y,z4,s,vehicle_name="Drone4")
    d5 = client.moveToPositionAsync(x,y,z5,s,vehicle_name="Drone5")
    d1.join()
    d2.join()
    d3.join()
    d4.join()
